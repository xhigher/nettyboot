...
@LogicAnnotation(module= BaseModules.rbac, action="duty_command_delete", method= LogicMethod.POST, parameters={
		AdminDataKey.dutyid,
		AdminDataKey.cmdid})
public class DutyCommandDelete extends AdminLogic {
