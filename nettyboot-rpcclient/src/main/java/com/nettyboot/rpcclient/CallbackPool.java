...
public class CallbackPool {
    ...
    private static final ConcurrentHashMap<String, CallbackContext> CALLBACK_MAP = new ConcurrentHashMap<String, CallbackContext>(
    ...
    public static void put(String requestId, long timeout) {
        CALLBACK_MAP.putIfAbsent(requestId, new CallbackContext(requestId, timeout));
    }
